...
help:
	...
	@echo "  make build-dist - Создать дистрибутивы (macOS .app и Windows .exe)"
	@echo "  make clean      - Очистить временные файлы"
	@echo "  make clean-dist - Очистить артефакты сборки"
	@echo "  make up         - Запустить приложение в Docker"
...
# Сборка дистрибутивов (macOS .app и Windows .exe)
build-dist:
	@echo "🔨 Сборка дистрибутивов..."
	@python3 build_distributables.py

# Очистка артефактов сборки
clean-dist:
	@echo "🧹 Очистка артефактов сборки..."
	@python3 build_distributables.py --clean 